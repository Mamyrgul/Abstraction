...
*/
        College college1 = new College("KGTU","Kyrgyzstan", LocalDate.of(1990,10,12),1990);
        College college2= new College("Politeh","Kazahstan",LocalDate.of(2020,2,14),2020);
        College college3= new College("KNU","Kyrgyzstan",LocalDate.of(1990,9,12),1990);

        School school1= new School("Kurmanzhan","Kazahstan",LocalDate.of(2013,6,23),2013);
        School school2= new School("Turganbaev","Uzbekstan",LocalDate.of(1998,3,30),1998);
        School school3= new School("Otunchiev","Kyrgyzstan",LocalDate.of(2020,11,3),2020);

        University university1 = new University("Garvard","America",LocalDate.of(1980,12,12),1980);
        University university2 = new University("Step Korea","Korea",LocalDate.of(1967,4,23),1967);
        University university3 = new University("Arabaev","Kyrgyzstan",LocalDate.of(2008,1,7),2008);
        University university4 = new University("KMU","Kyrgyzstan",LocalDate.of(2012,2,3),2012);
